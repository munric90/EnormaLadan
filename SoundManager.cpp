...
SoundManager::SoundManager()
{
	...
	// When player is 50 pixels away sound is full volume
	float minDistance = 150;
	// The sound reduces steadily as the player moves away
	float attenuation = 15;

	// Set all attenuation levels
...
void SoundManager::playFire(Vector2f emitterLocation, Vector2f listnerLocation)
{
	// Where is the listener? Thomas
	Listener::setPosition(listnerLocation.x, listnerLocation.y, 0.0f);
